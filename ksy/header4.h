...
class header4_t : public kaitai::kstruct {

public:

    header4_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, header4_t* p__root = nullptr);
    void _read();
    ~header4_t();
...
public:
    ...
    header4_t* _root() const { return m__root; }
